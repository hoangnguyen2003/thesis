...
def parse_args():
    ...
    p.add_argument('--alpha', type=float, default=1.0, help='weight for NT-Xent')
    p.add_argument('--beta', type=float, default=1.0, help='weight for CE ER')
    p.add_argument('--gamma', type=float, default=0.5, help='weight for prototype loss')
    p.add_argument('--delta', type=float, default=0.5, help='weight for M regression loss')
    ...
    p.add_argument('--knn_temp', type=float, default=0.1)
    p.add_argument('--transfer_conf', type=float, default=0.7)
    p.add_argument('--proto_mom', type=float, default=0.9)
    p.add_argument('--proto_margin', type=float, default=0.2)
    p.add_argument('--target_text_dim', type=int, default=0)
    p.add_argument('--target_audio_dim', type=int, default=0)
    p.add_argument('--target_vis_dim', type=int, default=0)
    p.add_argument('--device', type=str, default='cuda' if torch.cuda.is_available() else 'cpu')
    p.add_argument('--out', type=str, default='unified_improved.pkl')
    p.add_argument('--csv_out', type=str, default=None)
    p.add_argument('--save_every', type=int, default=2)
    p.add_argument('--checkpoint_prefix', type=str, default='improved_ckpt')
    return p.parse_args()
